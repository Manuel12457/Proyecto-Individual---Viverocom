...
import com.example.viverocom.Fragments.nav_historialdetalle;
import com.example.viverocom.R;
import com.example.viverocom.databinding.FragmentNavHistorialdetalleAdminBinding;
...
public class nav_historialdetalle_admin extends Fragment implements MenuProvider {
    ...
    private FragmentNavHistorialdetalleAdminBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentNavHistorialdetalleAdminBinding.inflate(inflater, container, false);
        ...
        valueEventListener = query.addValueEventListener(new nav_historialdetalle_admin.listener());
    ...
    public void onCreateMenu(@NonNull Menu menu, @NonNull MenuInflater menuInflater) {
        if (mostrarMenu) {
            menuInflater.inflate(R.menu.menu_historialdetalle, menu);
        }
    }
    ...
    public boolean onMenuItemSelected(@NonNull MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            case R.id.aceptarOrden:
                Log.d("menu", "ACEPTAR ORDEN");
                return true;
            case R.id.cancelarOrden:
                Log.d("menu", "CANCELAR ORDEN");
                return true;
        }
        return false;
    }
                        ...
                        ref.child("estado").setValue("PROCESADA")
                                .addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void unused) {
                                        Navigation.findNavController(view).navigate(R.id.nav_historial_admin);
                                        //SU SNACKBAR
                                    }
                                })
        ...
        public void onDataChange(@NonNull DataSnapshot snapshot) {
            if (snapshot.exists()) { //Nodo referente existe
                ...
                for (DataSnapshot ds : snapshot.getChildren()) {
                    ...
                    if (orden.getEstado().equals("CANCELADA") || orden.getEstado().equals("PROCESADA")) {
                        mostrarMenu = false;
                    }
                }
